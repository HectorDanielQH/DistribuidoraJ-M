...
@section('content')
    <div class="container mt-4">
        <div class="card shadow-sm" style="border-radius: 12px;">
            <div class="bg-warning d-flex align-items-center justify-content-between p-3 rounded-lg">
                <h3 class="card-title mb-0" style="font-size: 1.5rem; font-weight: 600;">
                    <i class="fas fa-edit me-2"></i> Editar Producto
                </h3>
                <a href="{{ route('administrador.productos.index') }}" class="btn btn-light btn-sm d-flex align-items-center justify-content-center">
                    <i class="fas fa-arrow-left mx-2"></i>Volver a la lista de productos
                </a>
            </div>
            <div class="card-body">
                <form action="{{ route('administrador.productos.update', ['producto' => $producto->id]) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="linea_producto" id="linea-producto" class="form-control select2 @error('linea-producto') is-invalid @enderror" style="width: 100%;" required>
                                    ...
                                    @foreach($lineas as $linea)
                                        <option value="{{ $linea->id }}" {{ $producto->id_linea == $linea->id ? 'selected' : '' }}>
                        ...
                        <div class="col-6">
                            <div class="form-group mb-3">
                                ...
                                <div class="d-flex align-items-center justify-content-start">
                                    <input type="text" name="codigo_producto" id="codigo-producto"
                                    value="{{ $producto->codigo }}"
                                    class="form-control @error('codigo_producto') is-invalid @enderror" value="{{ old('codigo_producto') }}" placeholder="Ingresa el código del producto" readonly required>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="nombre_producto" id="nombre-producto" value="{{ $producto->nombre_producto }}" class="form-control @error('nombre_producto') is-invalid @enderror" value="{{ old('nombre_producto') }}" placeholder="Ingresa el nombre del producto" required>
                        ...
                        <div class="col-6">
                            <div class="form-group mb-3">
                                ...
                                <input 
                                    ...
                                    class="form-control @error('descripcion_producto') is-invalid @enderror" value="{{ old('descripcion_producto') }}" placeholder="Ingresa la descripción del producto" required>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group mb-3">
                                ...
                                class="form-control @error('cantidad') is-invalid @enderror" value="{{ old('cantidad') }}" placeholder="Ingresa la cantidad" required>
                                @error('cantidad')
                                    <span class="text-danger" style="font-size: 0.875rem;">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="detalle_cantidad" id="detalle-cantidad"
                                value="{{ $producto->detalle_cantidad }}"
                                class="form-control @error('detalle_cantidad') is-invalid @enderror" value="{{ old('detalle_cantidad') }}" placeholder="Ingresa el detalle de la cantidad" required>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="number" step="0.01" name="precio_compra" id="precio-compra"
                                value="{{ $producto->precio_compra }}"
                                class="form-control @error('precio_compra') is-invalid @enderror" value="{{ old('precio_compra') }}" placeholder="Ingresa el precio de compra" required>
                                @error('precio_compra')
                                    <span class="text-danger" style="font-size: 0.875rem;">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="detalle_precio_compra" id="detalle-precio-compra"
                                value="{{ $producto->detalle_precio_compra }}"
                                class="form-control @error('detalle_precio_compra') is-invalid @enderror" value="{{ old('detalle_precio_compra') }}" placeholder="Ingresa el detalle de la compra" required>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group mb-3">
                                ...
                                class="form-control @error('presentacion') is-invalid @enderror" value="{{ old('presentacion') }}" placeholder="Ingresa la presentación del producto" required>
                                @error('presentacion')
                                    <span class="text-danger" style="font-size: 0.875rem;">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="checkbox" name="promocion" id="promocion" value="{{ $producto->promocion }}" {{ old('promocion') ? 'checked' : '' }} onclick="togglePromocionFields()"
                                ...
                                <div class="form-text">
                                    ...
                                    <input type="number" step="1" name="descripcion_descuento_porcentaje"
                                    value="{{ $producto->descripcion_descuento_porcentaje }}"
                                    id="descripcion-descuento-porcentaje" class="form-control @error('descripcion_descuento_porcentaje') is-invalid @enderror" value="{{ old('descripcion_descuento_porcentaje') }}" placeholder="Ingresa el descuento por porcentaje"
                                    @if(!$producto->promocion) disabled @endif
                                    >
                                </div>

                                <div class="form-text">
                                    <label for="descripcion-regalo" class="form-label" style="font-weight: 500;">Regalo</label>
                                    <input type="text" name="descuento_promocion" id="descripcion-regalo"
                                    value="{{ $producto->descripcion_regalo }}"
                                    class="form-control @error('descuento_promocion') is-invalid @enderror" value="{{ old('descuento_promocion') }}" placeholder="Ingresa el regalo" 
                                    @if(!$producto->promocion) disabled @endif
                                    >
                                </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group mb-3">
                                ...
                                <div>
                                    <img src="{{ route('productos.imagen', $producto->id) }}" id="preview-imagen-producto" alt="imagen del producto" style="max-width: 200px; max-height: 200px; margin-bottom: 10px;">
                                </div>
                        ...
                        <div class="col-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="date" name="fecha_vencimiento" id="fecha-vencimiento" class="form-control @error('fecha_vencimiento') is-invalid @enderror"
