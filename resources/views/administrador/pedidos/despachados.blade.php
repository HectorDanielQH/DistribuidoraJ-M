                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                        ...
                        <div class="card-tools d-flex">
                            ...
                            <x-adminlte-button label="Descagar por preventistas" data-toggle="modal" data-target="#modalMin" class="btn btn-success btn-sm"/>
                        </div>
                    </div>
                </div>
            </div>
...
@section('js')
    ...
    <script>
        ...
        function descargarPdfRutas() {
            ...
            let url = "{{ route('pedidos.administrador.visualizacionPdfDespachar.porPreventistas') }}?id_preventistas=" + ids;
