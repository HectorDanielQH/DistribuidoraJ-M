...
@section('content_header')
    <div class="container py-4" style="background: linear-gradient(135deg, #2c3e50, #34495e); border-radius: 16px; box-shadow: 0 8px 20px rgba(0, 0, 0, 0.15);">
        <div class="d-flex flex-column justify-content-center align-items-center text-center">
            ...
            <a
                href={{ route('administrador.mayoristas.crearProductoMayorista') }}
                class="btn btn-success mt-3 mb-2 px-4 py-2"
                id="agregar-nuevo-lote"
                style="border-radius: 8px;"
            >
                <i class="fas fa-plus"></i> Agregar nuevo producto mayorista
            </a>
        </div>
    </div>
@stop
...
@section('content')
    ...
    <div class="container pb-5">
        <table class="table table-bordered table-hover table-striped" id="tabla-mayoristas">
            <thead>
                <tr>
                    <th>Cod. Prod.</th>
                </tr>
    ...
    <script>
        $(document).ready(function(){
            $('#tabla-mayoristas').DataTable({
                ...
                "ajax": {
                    "url": "{{ route('administrador.mayoristas.index') }}",
                    "type": "GET",
                },
                columns:[
